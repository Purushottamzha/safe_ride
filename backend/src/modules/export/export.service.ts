...
export class ExportService {
  ...
  exportToExcel(
    ...
    this.logger.warn(
      'Excel export is not fully implemented. Returning CSV as fallback.',
    );
  ...
  exportToPdf(html: string): string {
    this.logger.warn(
      'PDF export is not fully implemented. Returning CSV as fallback.',
    );
  ...
  prepareReportData(
    ...
    switch (reportType) {
      case 'daily-attendance': {
        ...
        const headers = ['Student ID', 'Student Name', 'Grade', 'Section', 'Status', 'Late Minutes', 'Board Time', 'Exit Time'];
      ...
      case 'monthly-attendance': {
        ...
        const headers = ['Student ID', 'Student Name', 'Student ID Code', 'Grade', 'Section', 'Days Present', 'Days Absent', 'Attendance %'];
      ...
      case 'driver-performance': {
        ...
        const headers = ['Driver ID', 'Driver Name', 'Email', 'License Number', 'Total Trips', 'Completed', 'Cancelled', 'Active', 'Completion Rate %', 'On-Time Rate %'];
      ...
      case 'bus-utilization': {
        ...
        const headers = ['Bus ID', 'Plate Number', 'Bus Number', 'Capacity', 'Status', 'Total Trips', 'Completed Trips', 'Utilization Rate %', 'Students Transported', 'Events'];
      ...
      case 'late-students': {
        ...
        const headers = ['Student ID', 'Student Name', 'Grade', 'Section', 'Late Count', 'Total Late Minutes'];
      ...
      case 'attendance-heatmap': {
        ...
        const headers = ['Grade', 'Section', 'Present', 'Absent', 'Late', 'Excused', 'Total', 'Attendance Rate %'];
