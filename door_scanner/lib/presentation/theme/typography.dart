...
class AppTypography {
  ...
  static const TextStyle headlineMedium = TextStyle(fontSize: 24, fontWeight: FontWeight.w600);
  static const TextStyle titleLarge = TextStyle(fontSize: 20, fontWeight: FontWeight.w500);
