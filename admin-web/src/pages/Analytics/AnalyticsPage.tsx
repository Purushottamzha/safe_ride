...
import {
  Box, Grid, Card, CardContent, Typography, Chip, ToggleButtonGroup, ToggleButton,
...
function StatCard({ title, value, subtitle, icon, color, trend }: {
  ...
  return (
    <Card sx={{ borderRadius: 3, height: '100%', position: 'relative', overflow: 'visible' }}>
...
export default function AnalyticsPage() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      {overview && (
        <Box sx={{ mb: 3 }}>
          <Card sx={{ borderRadius: 3, bgcolor: '#f0fdf4', border: '1px solid #bbf7d0', mb: 2.5 }}>
